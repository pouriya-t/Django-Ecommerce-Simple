...
def payment(request):
    ...
    if not saved_address.is_fully_filled():
        messages.info(requests, "Please complete Shipping Address")
    ...
    store_id = 'abc6061a05c76768'
    API_Key = 'abc6061a05c76768@ssl'
    ...
    mypayment.set_urls(success_url=status_url,
                       fail_url=status_url, cancel_url=status_url, ipn_url=status_url)
    ...
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='Mixed', product_name=order_items, num_of_item=order_item_count,
